  ...
  return (
    <div className="flex flex-col items-center justify-center text-center flex-1">
      ...
      >
        ...
        <img src="/logo-only.png" alt="Autonomous Memory" className="relative size-16" />
      </motion.div>
      ...
      >
        ...
        Executive memory, built to last
      </motion.div>
      ...
      >
        Record meetings, import transcripts, and build a knowledge graph of every person, commitment, and decision. Private and on your machine.
      </motion.p>
        ...
        {rowboatState.isConnected ? (
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-2 text-green-600 dark:text-green-400">
              ...
              <span className="text-sm font-medium">Connected to Autonomous Memory</span>
            </div>
            <Button
              onClick={() => {
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            >
              {rowboatState.isConnecting ? (
                ...
                "Sign in with Autonomous Memory"
              )}
            </Button>
            {rowboatState.isConnecting && (
